...
def get_hand_rank_UT():
    ...
    straight_flush = sort_cards([Card(0,3), Card(0,4), Card(0,5), Card(0,6), Card(0,7), Card(2,12), Card(0,3)])
    four_of_a_kind = sort_cards([Card(0,3), Card(1,3), Card(2,3), Card(2,12), Card(3,7), Card(2,12), Card(0,3)])
    full_house = sort_cards([Card(0,0), Card(1,0), Card(2,0), Card(2,12), Card(3,7), Card(2,12), Card(0,3)])

    flush_hand = sort_cards([Card(0,2), Card(3,0)])
    flush_public = sort_cards([Card(2,0), Card(0,4), Card(0,3),  Card(0,2), Card(0,1)])
    
    straight = sort_cards([Card(0,0), Card(1,0), Card(2,4), Card(2,3), Card(3,2), Card(2,2), Card(0,1)])
    three_of_a_kind = sort_cards([Card(0,3), Card(1,0), Card(2,2), Card(2,3), Card(3,7), Card(2,6), Card(0,3)])
    two_pair = sort_cards([Card(0,0), Card(1,0), Card(2,2), Card(2,12), Card(3,7), Card(2,7), Card(0,3)])
    one_pair = sort_cards([Card(0,0), Card(1,0), Card(2,2), Card(2,12), Card(3,7), Card(2,6), Card(0,3)])
    high_card_list = sort_cards([Card(0,0), Card(1,2), Card(2,4), Card(3,6), Card(3,8), Card(2,10), Card(1,12)])

    hand_rank, high_card = get_hand_rank(straight_flush, [])
    if(hand_rank != 8 and high_card != 7):
        print("get_hand_rank_UT fail: straight_flush")
        UT = Test.FAIL

    hand_rank, high_card = get_hand_rank(four_of_a_kind, [])
    if(hand_rank != 7 and high_card != 3):
        print("get_hand_rank_UT fail: four_of_a_kind")
        UT = Test.FAIL

    hand_rank, high_card = get_hand_rank(full_house, [])
    if(hand_rank != 6 and high_card != 0):
        print("get_hand_rank_UT fail: full_house")
        UT = Test.FAIL

    hand_rank, high_card = get_hand_rank(flush_hand, flush_public)
    if(hand_rank != 5 and high_card != 0):
        print("get_hand_rank_UT fail: flush")
        UT = Test.FAIL

    hand_rank, high_card = get_hand_rank(straight, [])
    if(hand_rank != 4 and high_card != 4):
        print("get_hand_rank_UT fail: straight")
        UT = Test.FAIL

    hand_rank, high_card = get_hand_rank(three_of_a_kind, [])
    if(hand_rank != 3 and high_card != 3):
        print("get_hand_rank_UT fail: three_of_a_kind")
        UT = Test.FAIL

    hand_rank, high_card = get_hand_rank(two_pair, [])
    if(hand_rank != 2 and high_card != 0):
        print("get_hand_rank_UT fail: two_pair")
        UT = Test.FAIL

    hand_rank, high_card = get_hand_rank(one_pair, [])
    if(hand_rank != 1 and high_card != 0):
        print("get_hand_rank_UT fail: one_pair")
        UT = Test.FAIL

    
    hand_rank, high_card = get_hand_rank(high_card_list, [])
    if(hand_rank != 0 and high_card != 0):
        print("get_hand_rank_UT fail: high_card")
        UT = Test.FAIL
...
def is_straight_flush_UT():
    ...
    if(straight_flush != True or high_card != 7):
        UT = Test.FAIL
        print("is_straight_flush_UT #1 FAILURE")
    ...
    if(straight_flush != True or high_card != 9):
        UT = Test.FAIL
        print("is_straight_flush_UT #2 FAILURE")
    ...
    if(straight_flush != True or high_card != 4):
        UT = Test.FAIL
        print("is_straight_flush_UT #3 FAILURE")
    ...
    if(straight_flush != True or high_card != 0):
        UT = Test.FAIL
        print("is_straight_flush_UT #4 FAILURE")
    ...
    if(straight_flush != False or high_card != None):
        UT = Test.FAIL
        print("is_straight_flush_UT #5 FAILURE")
    ...
    if(straight_flush != False or high_card != None):
        UT = Test.FAIL
        print("is_straight_flush_UT #6 FAILURE")
    ...
    if(straight_flush != False or high_card != None):
        UT = Test.FAIL
        print("is_straight_flush_UT #7 FAILURE")
...
def is_four_of_a_kind_UT():
    ...
    if(four_of_a_kind != True or high_card != 3):
        UT = Test.FAIL
        print("is_four_of_a_kind_UT #1 FAILURE")
    ...
    if(four_of_a_kind != True or high_card != 0):
        UT = Test.FAIL
        print("is_four_of_a_kind_UT #2 FAILURE")
    ...
    if(four_of_a_kind != False or high_card != None):
        UT = Test.FAIL
        print("is_four_of_a_kind_UT #3 FAILURE")
    ...
    if(four_of_a_kind != False or high_card != None):
        UT = Test.FAIL
        print("is_four_of_a_kind_UT #4 FAILURE")
...
def is_full_house_UT():
    ...
    if(full_house != True or high_card != 0):
        UT = Test.FAIL
        print("is_full_house_UT #1 FAILURE")
    ...
    if(full_house != True or high_card != 0):
        UT = Test.FAIL
        print("is_full_house_UT #2 FAILURE")
...
def is_three_of_a_kind_UT():
    ...
    if(three_of_a_kind != True or high_card != 3):
        UT = Test.FAIL
        print("is_three_of_a_kind_UT #1 FAILURE")
    ...
    if(three_of_a_kind != True or high_card != 0):
        UT = Test.FAIL
        print("is_three_of_a_kind_UT #2 FAILURE")
    ...
    if(three_of_a_kind != False or high_card != None):
        UT = Test.FAIL
        print("is_three_of_a_kind_UT #3 FAILURE")
...
def is_straight_UT():
    ...
    if(straight != True or high_card != 4):
        UT = Test.FAIL
        print("is_straight_UT #1 FAILURE")
    ...
    if(straight != True or high_card != 4):
        UT = Test.FAIL
        print("is_straight_UT #2 FAILURE")
    ...
    if(straight != True or high_card != 0):
        UT = Test.FAIL
        print("is_straight_UT #3 FAILURE")
    ...
    if(straight != False or high_card != None):
        UT = Test.FAIL
        print("is_straight_UT #4 FAILURE")
    ...
    if(straight != False or high_card != None):
        UT = Test.FAIL
        print("is_straight_UT #5 FAILURE")
